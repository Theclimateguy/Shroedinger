#!/usr/bin/env python3
"""Phase-6 download: 6-hourly CAPE for the b2b region-windows.
...
def run_job(region: str, area: list[float], window: str, year: str,
    ...
    target = out_dir / f"era5_cape6h_{region}__{window}.nc"
...
def main() -> None:
    ...
    parser.add_argument("--out-dir", type=Path, default=Path("data/b6cape"))
