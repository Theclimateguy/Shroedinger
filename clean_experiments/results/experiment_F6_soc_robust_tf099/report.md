...
## SOC Parameters
- transfer_fraction = 0.9900
- cap_power = 2.2000
- p_cap(epsilon) = 0.999 * balance(epsilon)^cap_power
- p_scale = 1.4000

## Main Fit at epsilon*
- alpha_measured (mean over seeds) = 1.526474
- alpha 95% seed interval = [1.497717, 1.584070]
- relative error |alpha_measured-alpha_pred|/alpha_pred = 0.913%
- fit R2 mean = 0.978128
- tail dynamic range (median) = 587.839
