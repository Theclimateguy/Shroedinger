...
- modeling dataset: `clean_experiments/results/experiment_M_realpilot_v1_frozen_independent_geographic_southwest_2024/modeling_dataset.csv`
- target: `target_next_mrms_p95`
- ridge_alpha: 10.0
- permutations per variant: 499

## Headline
- ABI-only mean gain: -0.011403
- ABI+GLM mean gain: -0.016272
- delta (ABI+GLM - ABI-only): -0.004868
