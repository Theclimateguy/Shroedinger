...
## Main Fit at epsilon*
- alpha_measured (mean over seeds) = 2.248278
- alpha 95% seed interval = [2.208999, 2.299977]
- relative error |alpha_measured-alpha_pred|/alpha_pred = 45.941%
- fit R2 mean = 0.944083
- tail dynamic range (median) = 33.848
- failed seed share = 0.000

## Criteria
- epsilon_star_in_window: False
- tail_r2_gt_threshold (0.95): False
