...
- phi selection mode: `screened`
- selected proxy bands: `0` / `2`
- selected phi candidate: `pop_x_delta`
- common valid rows: `4380`

## Headline metrics
- baseline M1 oof_gain_frac (from summary): `0.003412`
- ERA5+Lambda gain_vs_ctrl: `0.003412`, perm_p=`0.007092`
- ERA5+Lambda+Phi_GKSL gain_vs_ctrl: `0.005800`
- ERA5+Lambda+Phi_GKSL gain_vs_lambda: `0.002396`, perm_p_inc=`0.007092`
- shuffled control gain_vs_lambda: `-0.000977`, perm_p_inc=`0.914894`

## GKSL diagnostics
- max cptp violation proxy: `1.110e-15`
- mean gamma_dephase: `0.996729`
