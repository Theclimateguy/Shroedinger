...
| `A05.R6_p2_memory_gksl_cptp` | Full effective GKSL/CPTP memory closure for dense fine-scale transfer | `clean_experiments/experiment_P2_memory_gksl_cptp.py` | `clean_experiments/results/experiment_P2_memory_gksl_cptp` |
