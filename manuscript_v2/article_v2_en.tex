% SUPERSEDED 2026-08-16. This English text still describes the index A as a
% measure of the irreversibility of generalisation. That interpretation was
% retracted by Phase 12 (docs/PROTOCOL_PHASE12_ESTIMATOR_VALIDITY.md): A does
% not respond to controlled irrecoverability and tracks temporal persistence
% instead. The current text is manuscript_v2/article_v3.tex (Russian), where
% the coupling profile P is the primary object. This file is kept for the
% record and should not be cited as the current state of the work.
